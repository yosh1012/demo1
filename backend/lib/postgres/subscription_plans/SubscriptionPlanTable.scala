...
class SubscriptionPlanTable(tag: Tag) extends Table[SubscriptionPlan](tag, "subscription_plans") {
    ...
    def spl_regular_price = column[BigDecimal]("spl_regular_price")
    def spl_discount_3months = column[Option[BigDecimal]]("spl_discount_3months")
    def spl_discount_6months = column[Option[BigDecimal]]("spl_discount_6months")
    def spl_discount_1year = column[Option[BigDecimal]]("spl_discount_1year")
    def spl_3months_monthly_price = column[Option[BigDecimal]]("spl_3months_monthly_price")
    def spl_6months_monthly_price = column[Option[BigDecimal]]("spl_6months_monthly_price")
    def spl_1year_monthly_price = column[Option[BigDecimal]]("spl_1year_monthly_price")
    def spl_additional_user_price = column[Option[BigDecimal] ]("spl_additional_user_price")
