...
class UserTable(tag: Tag) extends Table[User](tag, "users") {
    ...
    def usr_last_login_at = column[Option[java.time.LocalDateTime]]("usr_last_login_at")
    def usr_is_active = column[Boolean]("usr_is_active")
    def usr_created_at = column[java.time.LocalDateTime]("usr_created_at") // DEFAULT CURRENT_TIMESTAMP
    def usr_updated_at = column[Option[java.time.LocalDateTime]]("usr_updated_at")
    def usr_deleted_at = column[Option[java.time.LocalDateTime]]("usr_deleted_at")
